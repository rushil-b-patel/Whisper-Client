...
export const SubLinksBox = (props) => {
  ...
  return (
    <div className="absolute top-10 w-fit bg-slate-50 dark:bg-gray-900 shadow-[rgba(0,_0,_0,_0.24)_0px_0px_40px] shadow-slate-300 dark:shadow-slate-900 hidden group-hover:flex rounded-xl">
