...
export function Reply(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path fillRule="evenodd" d="M5.478 5.559A1.5 1.5 0 016.912 4.5H9A.75.75 0 019 6H6.912a.75.75 0 00-.75.75v8.5c0 .414.336.75.75.75h8.5a.75.75 0 00.75-.75v-5a.75.75 0 011.5 0v5a2.25 2.25 0 01-2.25 2.25h-8.5a2.25 2.25 0 01-2.25-2.25v-8.5a2.25 2.25 0 01.616-1.556l.6.6z" clipRule="evenodd" />
      <path fillRule="evenodd" d="M10.5 9a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" clipRule="evenodd" />
      <path fillRule="evenodd" d="M15.44 10.145a.75.75 0 01.09 1.057l-2.25 2.75a.75.75 0 01-1.151-.02l-1.5-1.75a.75.75 0 111.143-.975l.97 1.142 1.683-2.06a.75.75 0 011.015-.144z" clipRule="evenodd" />
    </svg>
  );
}