...
function PostCard({ post }) {
  ...
  return (
    <div className="relative bg-white w-full sm:max-w-xl mx-auto 
    ...
    >
      <div className="flex items-start sm:items-center mb-3 sm:mb-5 relative">
        <div className="relative group">
          ...
          <img
            ...
            alt={post.author}
            className="w-5 h-5 sm:w-8 sm:h-8 rounded-full object-cover relative z-10
        ...
        <div className="ml-3 sm:ml-4 max-w-[80%]">
          <h2 className="font-mono text-base sm:text-md font-bold bg-gradient-to-r from-indigo-600 to-violet-600 
      ...
      <p className="font-mono text-sm sm:text-base text-black mb-3 sm:mb-5 
                   leading-relaxed pl-2 sm:pl-3 dark:text-white
      ...
      <div className="flex justify-between items-center pl-2 sm:pl-3">
        <div className="flex items-center space-x-4 sm:space-x-6">
          <button className="group flex items-center text-black hover:text-indigo-500 
                          transition-colors dark:text-white dark:hover:text-indigo-400">
