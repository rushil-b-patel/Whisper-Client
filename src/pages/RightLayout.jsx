        ...
        {user ? (
          statsLoading ? (
            ...
            <div className="text-center py-6">
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">{statsError}</p>
              <button
          ...
          <div className="text-center">
            <h2 className="text-lg font-bold mb-2">Join Whisper</h2>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              Sign up to share posts and interact with the community.
            </p>
            <button
              onClick={() => navigate('/signup')}
              className="w-full py-2 bg-black hover:bg-gray-900 text-white rounded-lg font-medium text-sm transition mb-3"
            >
              Sign Up
            </button>
            <p className="text-sm text-gray-500 dark:text-gray-400">
